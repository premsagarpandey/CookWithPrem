...
// ============================================
// CookWithPrem — Edit Recipe (Admin)
// ============================================
...
import { getRecipeById, updateRecipe } from "@/lib/firebase/firestore";
    ...
    const fetchRecipe = async () => {
      try {
        ...
        if (recipe) {
          ...
          if (recipe.steps?.length) setSteps(recipe.steps);
          if (recipe.tools?.length) setTools(recipe.tools);
          if (recipe.tags?.length) setTags(recipe.tags);
          if (recipe.faqs?.length) setFaqs(recipe.faqs);
        } else {
    ...
    try {
      ...
      const recipeData = {
        ...
        nutrition: {
          ...
          protein: "0g", // Simplified for demo
          carbs: "0g",
          fat: "0g",
          fiber: "0g",
          sugar: "0g",
                ...
                <label className="btn-secondary text-sm cursor-pointer">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (file) {
                        setHeroFile(file);
                        setValue("heroImage", file.name); // Temporary value for visual
                      }
                    }}
                  />
                </label>
